...
@student3.confirm!
@student4 = Student.create! :email => 'fouradmin@diplomatiki.gr', :password => '12345678', :fullname => 'admin Four', :lesson_id => '6', :weburl => 'http://www.diplomatiki.eu', :shortbio => 'Short biography of Admin4'
@student4.confirm!
@student5 = Student.create! :email => 'fiveadmin@diplomatiki.gr', :password => '12345678', :fullname => 'admin Five', :lesson_id => '1', :weburl => 'http://www.diplomatiki.eu', :shortbio => 'Short biography of Admin5'
@student5.confirm!
