...
class CommentsController < ApplicationController
  ...
  # create a comment and bind it to an question and a user
  def create
    ...
    respond_to do |format|
      if @question.state > 2
        ...
        format.html { redirect_to(@question, :notice => 'Τα σχόλια μπορούν να γίνουν μόνο σε δημοσιευμένες ερωτήσει.') }
      end
    end
  end
